...
### Installing
Download the release zip folder and unpack it, and move the "MultiTouchKitUI" folder in your Processing Libraries folder. Make sure to restart processing after doing so.
